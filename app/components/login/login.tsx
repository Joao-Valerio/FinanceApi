...
export function Login() {
  ...
  return (
<<<<<<< HEAD:FinanceApi/app/components/login/login.tsx
    <div>
=======
    <div className="min-h-screen dark:bg-gray-900">
>>>>>>> bf5597c5a60cb934a637808e5c30cbd5212414f7:app/components/login/login.tsx
...
=======
  ...
  <button onClick={() => setIsOpen(true)} className="block mx-auto text-center text-sm text-black hover:text-gray-500 mt-4 dark:text-gray-400 dark:hover:text-white">
>>>>>>> bf5597c5a60cb934a637808e5c30cbd5212414f7:app/components/login/login.tsx
    Esqueceu sua senha?
  </button>
    {isOpen && (
