      ...
      <aside className={`fixed top-0 left-0 h-full w-64 bg-gray-100 dark:bg-gray-800 p-6 shadow-xl z-30 transition-transform duration-300 
        ...
        <nav>
          <ul className="space-y-4">
            <li><Link to="/dashboard" className="block p-2 bg-green-600 text-white rounded font-semibold shadow-md">Dashboard</Link></li>
            ...
            <li><Link to="/contato" className="block p-2 hover:bg-green-100 text-white rounded font-semibold shadow-md">Contato</Link></li>
          </ul>
        </nav>
